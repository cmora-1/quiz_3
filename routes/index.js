...
router.get('/user/:userId(\\d+)/favourites',                favController.show);
router.put('/user/:userId(\\d+)/favourites/:quizId(\\d+)',  favController.marcar);
router.delete('/user/:userId(\\d+)/favourites/:quizId(\\d+)', favController.quitar);
